...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    # Handle both absolute and relative manifest_dir paths
    if(IS_ABSOLUTE "${manifest_dir}")
        set(CARGOKIT_RESOLVED_MANIFEST_DIR "${manifest_dir}")
    else()
        get_filename_component(CARGOKIT_RESOLVED_MANIFEST_DIR "${CMAKE_CURRENT_SOURCE_DIR}/${manifest_dir}" REALPATH)
    endif()

    set(CARGOKIT_ENV
        "CARGOKIT_CMAKE=${CMAKE_COMMAND}"
        "CARGOKIT_CONFIGURATION=$<CONFIG>"
        "CARGOKIT_MANIFEST_DIR=${CARGOKIT_RESOLVED_MANIFEST_DIR}"
